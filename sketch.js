...
//  run45 = setInterval(function(){genBalls(1);}, interval_45); // scene changing T
 ...
 scattering_c = setInterval(function(){scattering();}, 1000); // scattring time 
...
/////////////////
  ...
  //temp draw
    ...
    var target = createVector(300, 300);
      ...
      // for (let i = 0; i < whiteArray.length; i++) {
      //   if ((whiteArray[i].x <=(190*s_x)) && (whiteArray[i].x >=(150*s_x)) && (whiteArray[i].box ==0)){
...
//       curveVertex((190+k*(950-190)/point_count)*s_x,(171.25-array_plot[k].length*0.7)*s_y)
//     // }
//   }
 
//   // if (i==(point_count-1)) {
//     curveVertex((950-(950-190)/point_count)*s_x,(171.25-array_plot[point_count-1].length*0.7)*s_y)
//   // }
// // }
...
//   for (var k = 0; k < point_count; k++) {
//     // if (i!=(point_count-1)||i!=(0)) {
//       curveVertex((190+k*(950-190)/point_count)*s_x,((10+385/2+96.25)+(array_positive_y[k].length-array_negative_y[k].length))*s_y)
//     // }
//   }
 
//   // if (i==(point_count-1)) {
//     curveVertex((950-(950-190)/point_count)*s_x,((10+385/2+96.25)+(array_positive_y[point_count-1].length-array_negative_y[point_count-1].length))*s_y)
//   // }
// // }
...
// fill(125, 241, 148)
// for (var k = 0; k < point_count; k++) {
// rect((190+k*(950-190)/point_count)*s_x,(10+385/2+96.25)*s_y,((950-190)/point_count)*s_x,(array_positive_y[k].length-array_negative_y[k].length)*2.5*s_y)
// }
    ...
    //       //horizon
    // line((10+100+70+change_square+940-change_length-70-760)*s_x,171.25*s_y,(10+100+70+change_square+790)*s_x,171.25*s_y)

    //       //vertical
    // line((10+100+70+change_square+940-change_length-70-760)*s_x,40*s_y, (10+100+70+change_square+940-change_length-70-760)*s_x, 171.25*s_y)

    //   //down
    //       //horizon
    //       line((10+100+70+change_square+940-change_length-70-760)*s_x,(10+385/2+96.25)*s_y,(10+100+70+change_square+790)*s_x,(10+385/2+96.25)*s_y)
    //       //vertical
    // line((10+100+70+change_square+940-change_length-70-760)*s_x,(10+385/2+96.25-70)*s_y, (10+100+70+change_square+940-change_length-70-760)*s_x, (10+385/2+96.25+70)*s_y)
    ...
    context_1.beginPath();
        ...
        context_1.rect((10+100+70+change_square)*s_x,(10)*s_y,(940-change_length-70-760)*s_x,(770)*s_y);
        context_1.closePath();
    context_1.stroke();
...
// for ( var i = 0; i < point_count; i++ ) {
  // if (i==0 ) {
    curveVertex(170*s_x,(171.25-array_plot_0.length*0.7)*s_y)
    curveVertex(170*s_x,(171.25-array_plot_0.length*0.7)*s_y)
    // curveVertex(190*s_x,(171.25-array_plot[0].length*0.7)*s_y)
...
// for ( var i = 0; i < point_count; i++ ) {
  // if (i==0 ) {
    curveVertex(170*s_x,((10+385/2+96.25)+(array_positive_y_0.length-array_negative_y_0.length))*s_y)
    curveVertex(170*s_x,((10+385/2+96.25)+(array_positive_y_0.length-array_negative_y_0.length))*s_y)
    // curveVertex(190*s_x,((10+385/2+96.25)+(array_positive_y[0].length-array_negative_y[0].length))*s_y)
...
// }
    ...
    line((10+100+70+change_square+940-change_length-70-760-20)*s_x,40*s_y, (10+100+70+change_square+940-change_length-70-760-20)*s_x, 171.25*s_y)
      ...
      //down
          //horizon
          line((10+100+70+change_square+940-change_length-70-760-20)*s_x,(10+385/2+96.25)*s_y,(10+100+70+change_square+790)*s_x,(10+385/2+96.25)*s_y)
          //vertical
...
setTemperature_real = (te) => {
  ...
  // 
  for (let i=0; i < whiteArray.length; i ++){
whiteArray[i].movingVelocity = 5*parseInt(constant_temperature_real/20)/5;
  }
...
setScattering = (c) => {
  ...
  // console.log(scattering_count_c)
}
...
genBalls_scene1 = (num) =>{
  ...
  // generate *num* balls
if (loopp = true && sceneCount ==0.55 || sceneCount ==0.5|| sceneCount ==0.7  || sceneCount ==1  || sceneCount ==2 || sceneCount ==3|| sceneCount ==3.1 && whiteArray.length<13000) {
